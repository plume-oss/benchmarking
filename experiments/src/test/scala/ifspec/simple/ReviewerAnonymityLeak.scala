...
class ReviewerAnonymityLeak extends JimpleDataflowFixture {
  ...
  "[True Positive] The reviewer identities" should "be kept secret. The observer is assumed to be an author, " +
