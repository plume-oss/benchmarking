...
class ScenarioBankingInsecure extends JimpleDataflowFixture {

  behavior of
    """This example describes a banking scenario. The AccountOwner has an Account and can pay an amount to a
      |beneficiary. The successfully completed transactions are logged in a TransactionLog, while errors are written
      |down in an ErrorLog.
      |""".stripMargin
  ...
  "[True Positive] The requirement is to be disallow information flows from Account.balance to ErrorLog.logError. " +
